...
#if OPENVLC_COMP_HYSTERESIS_LEVEL == OPENVLC_COMP_HYSTERESIS_NONE
  hcomp1.Init.Hysteresis = COMP_HYSTERESIS_NONE;
#elif OPENVLC_COMP_HYSTERESIS_LEVEL == OPENVLC_COMP_HYSTERESIS_LOW
  hcomp1.Init.Hysteresis = COMP_HYSTERESIS_LOW;
#elif OPENVLC_COMP_HYSTERESIS_LEVEL == OPENVLC_COMP_HYSTERESIS_MEDIUM
